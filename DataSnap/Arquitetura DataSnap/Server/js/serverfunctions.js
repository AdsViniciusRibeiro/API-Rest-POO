...
function TServerMethods(connectionInfo)
{
  ...
  /*
   * @param _AJSONValue [in] - Type on server: TJSONValue
   * @return result - Type on server: TJSONValue
   */
  this.updatePessoa = function(_AJSONValue) {
    var returnObject = this.executor.executeMethod('Pessoa', "POST", [_AJSONValue], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject._AJSONValue = _AJSONValue;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
   ...
   * @return result - Type on server: TJSONValue
   */
  this.ListarPessoa = function() {
    var returnObject = this.executor.executeMethod('ListarPessoa', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.ListarPessoa_URL = function() {
    return this.executor.getMethodURL("ListarPessoa", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TJSONValue
   */
  this.RetornaMaiorID = function() {
    var returnObject = this.executor.executeMethod('RetornaMaiorID', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.RetornaMaiorID_URL = function() {
    return this.executor.getMethodURL("RetornaMaiorID", "GET", [], arguments[0])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods": ["EchoString","ReverseString","updatePessoa","ListarPessoa","RetornaMaiorID"]
};
